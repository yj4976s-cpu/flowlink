...
export interface DaruHistoryResponse { difficulty: ApiGameDifficulty; items: DaruHistoryItem[]; total: number; page: number; page_size: number; total_pages: number; protected_count: number; deletable_count: number; has_deletable_best: boolean; has_deletable_best_any_difficulty: boolean; }
