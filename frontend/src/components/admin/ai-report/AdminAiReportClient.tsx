...
export function AdminAiReportClient() {
  ...
  return <main className={styles.page}>
    <header className={styles.intro}><div><p>ADMIN · AI OPERATIONS</p><h1>AI 성능 분석</h1><span>AI 탐지 결과와 운영 검토 데이터를 기반으로 현재 탐지 품질과 취약 클래스를 확인하세요.</span></div><small>전체 운영 탐지 데이터 기준</small></header>
