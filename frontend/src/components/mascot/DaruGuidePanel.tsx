...
export function DaruGuidePanel({ role, userPaused, reducedMotion, onClose, onToggleRoaming }: { role: DaruGuideRole; userPaused: boolean; reducedMotion: boolean; onClose: () => void; onToggleRoaming: () => void }) {
  ...
  return (
    <section id="daru-guide-panel" className={styles.guidePanel} role="dialog" aria-modal="false" aria-labelledby="daru-guide-title">
      <header className={styles.guideHeader}>
        ...
        <button type="button" aria-label="다루 안내 닫기" onClick={onClose}><Icon name="close" size={17} /></button>
      </header>
