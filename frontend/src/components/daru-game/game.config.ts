...
export const DIFFICULTY_CONFIG: Record<GameDifficulty, DifficultyConfig> = {
  easy: { key: "EASY", label: "쉬움", description: "워밍업", cardCount: 20, pairCount: 10, timeLimitSeconds: 120, speedBenchmarkSeconds: 90, hintCount: 2, hintRevealSeconds: 4, comboTarget: 5, clearBonus: 300, previewSeconds: 5 },
  normal: { key: "NORMAL", label: "보통", description: "집중 모드", cardCount: 32, pairCount: 16, timeLimitSeconds: 210, speedBenchmarkSeconds: 150, hintCount: 2, hintRevealSeconds: 6, comboTarget: 7, clearBonus: 500, previewSeconds: 7 },
  hard: { key: "HARD", label: "어려움", description: "풀 챌린지", cardCount: 40, pairCount: 20, timeLimitSeconds: 280, speedBenchmarkSeconds: 200, hintCount: 2, hintRevealSeconds: 8, comboTarget: 8, clearBonus: 700, previewSeconds: 8 },
};
