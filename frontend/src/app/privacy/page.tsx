        ...
        <article className="document-card">
          <section aria-labelledby="privacy-data">
            ...
            <ul>
              ...
              <li><strong>분실 신고 정보:</strong> 물품 종류, 색상, 특징, 분실 추정 위치와 시간, 사진 첨부 기능을 이용하는 경우 사용자가 첨부한 사진</li>
            </ul>
          ...
          <section aria-labelledby="privacy-withdrawal">
            ...
            <p>회원은 탈퇴를 요청할 수 있습니다. 현재 데모에서는 탈퇴 처리 시 계정을 비활성화하고 탈퇴 시각을 기록합니다. 계정과 관련 기록은 참조 관계와 서비스 처리 상태 확인을 위해 즉시 물리 삭제되지 않을 수 있습니다.</p>
            <p>실제 상용 서비스 운영 전에는 보관, 파기, 익명화 기준을 서비스 구조와 적용 법령에 맞춰 별도로 확정합니다.</p>
          </section>
