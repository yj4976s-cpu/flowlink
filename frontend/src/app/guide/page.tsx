    ...
    <div className="site-shell">
      ...
      <main className="info-page guide-page">
        ...
        <section className="guide-ai" aria-labelledby="guide-ai-title">
          ...
          <div className="guide-ai-classes"><article><div><Icon name="packageCheck" size={20} /><strong>폐기물</strong></div><p>플라스틱 · 비닐 · 캔 · 스티로폼</p></article><article><div><Icon name="archive" size={20} /><strong>개인 물품 후보</strong></div><p>공 · 가방·백팩 · 우산 · 신발·슬리퍼류</p></article></div>
