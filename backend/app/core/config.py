...
class Settings(BaseSettings):
    ...
    USER_IMAGE_SOURCE_MAX_BYTES: int = 20 * 1024 * 1024
    USER_IMAGE_SOURCE_MAX_PIXELS: int = 50_000_000
    USER_IMAGE_NORMALIZED_MAX_EDGE: int = 2560
    USER_IMAGE_NORMALIZED_TARGET_BYTES: int = 4 * 1024 * 1024
    USER_IMAGE_NORMALIZED_HARD_MAX_BYTES: int = 5 * 1024 * 1024
    USER_VIDEO_MAX_BYTES: int = 100 * 1024 * 1024
    USER_VIDEO_MAX_DURATION_SECONDS: int = 30
    USER_VIDEO_MAX_SOURCE_EDGE: int = 4096
    USER_VIDEO_NORMALIZED_MAX_WIDTH: int = 1920
    USER_VIDEO_NORMALIZED_MAX_HEIGHT: int = 1080
    USER_VIDEO_NORMALIZED_MAX_FPS: int = 30
    USER_VIDEO_FFPROBE_TIMEOUT_SECONDS: float = 20.0
    USER_VIDEO_FFMPEG_TIMEOUT_SECONDS: float = 180.0
    USER_IMAGE_ROLLING_24H_LIMIT: int = 50
    USER_VIDEO_ROLLING_24H_LIMIT: int = 5
    USER_MEDIA_STORAGE_LIMIT_BYTES: int = 1024 * 1024 * 1024
    USER_ACTIVE_VIDEO_JOB_LIMIT: int = 1
