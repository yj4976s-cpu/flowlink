...
TEAM_ROLE_KEYWORDS = {
    "dataset": ("데이터셋", "데이터", "라벨링", "roboflow", "로보플로우"),
    "presentation": ("발표", "발표자료", "ppt", "자료"),
    "ai": ("ai서비스", "ai 서비스", "ai 담당", "ai 이미지", "ai 영상", "backend ai", "백엔드 ai"),
    "admin": ("관리자서비스", "관리자 서비스", "관리자 담당", "관리자 화면", "관리자 대시보드"),
}
